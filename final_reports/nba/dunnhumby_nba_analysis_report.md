...
**[Evidence 1: 페르소나별 재구매율(Precision) 비교 차트]**
![재구매율 비교](plots/nba_retention_rate_comparison.png)

위 차트는 Q2에서 언급한 "왜 신규 고객에게는 안전한 리스트를 추천해야 하는가?"에 대한 명확한 데이터 근거입니다. 붉은색 막대로 표시된 **New/Light Users (92.3%)**는 타 그룹 대비 현저히 낮은 재구매율을 보이고 있어, 아직 취향이 정착되지 않은 '탐색기'에 있음을 시각적으로 증명합니다.
