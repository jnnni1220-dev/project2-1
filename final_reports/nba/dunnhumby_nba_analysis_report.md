...
**[추천 엔진 작동 원리]**
- **Hybrid Score**: 과거 구매 이력(CF) 60%와 상품 텍스트 속성(CBF) 40%를 결합한 점수입니다.
- **Demographic Score**: 인구통계(소득 등) 기반의 베스트셀러 점수입니다.
- **박스플롯(Boxplot) 해석**: 상자가 높게 위치할수록 해당 추천 방식이 고객에게 더 강력한 구매 동기를 부여함을 뜻합니다.
...
- **핵심 발견**: **Hybrid 방식**의 중앙값이 Demo 방식보다 유의미하게 높게 형성됩니다. 
- **통계적 의미**: 개인화 모델이 단순히 인기 상품을 나열하는 것보다 훨씬 더 정밀한 추천을 수행하고 있음을 입증합니다.
...
- **지표 해설**: 특정 품목에 치우치지 않고 식품, 음료, 제과 등 다양한 카테고리가 고르게 추천되고 있습니다. 
- **비즈니스 효과**: 고객의 쇼핑 범위를 자연스럽게 확장시켜(Cross-selling) 매출 성장을 견인합니다.
...
- **핵심 발견**: 소득 수준에 따라 추천되는 카테고리의 스펙트럼이 뚜렷하게 다릅니다.
- **인사이트**: 각 소득 계층의 고유한 라이프스타일을 시스템이 정밀하게 타겟팅하고 있음을 방증합니다.
...
- **지표 해설**: **다양성(35.4%)**과 **의외성(8.5%)** 지표는 '필터 버블'을 방지하고 고객에게 새로운 발견의 즐거움을 제공하고 있음을 나타냅니다. 
